...
using LinearAlgebra, Plots, DebuggingUtilities
...
using .HopfReachability_dev: Hopf_BRS, Hopf_admm, Hopf_cd, intH_ytc17, preH_ytc17, HJoc_ytc17, plot_BRS, Hopf, Hopf_minT
...
plot_scatter = plot_BRS(T, B⁺T, ϕB⁺T; M, ϵs=1e-2, interpolate=false, value_fn=false, alpha=0.5)
plot_contour = plot_BRS(T, B⁺T, ϕB⁺T; M, ϵc=1e-3, interpolate=true, value_fn=false, alpha=0.5)
...
## Test a Single Call
x = [-0.8, 2.4] # from our plots should be controllable at T ≈ 0.4
uˢ, dˢ, Tˢ, ϕ, dϕdz = Hopf_minT(system, target, intH_ytc17, HJoc_ytc17, x; preH=preH_ytc17, time_p=(5e-2, 1e-1, Tf + ϵ), printing=true, refine=0.5, refines=4);
