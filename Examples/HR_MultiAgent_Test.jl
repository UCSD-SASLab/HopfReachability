...
uˢ, dˢ, Tˢ, ϕ, dϕdz = Hopf_minT(system, targets[1], x; opt_method=Hopf_cd, opt_p=opt_p_cd, preH=preH_mrk18, intH=intH_mrk18, HJoc=HJoc_mrk18, time_p, printing=true, warm=true)
uˢ, dˢ, Tˢ, ϕ, dϕdz2 = Hopf_minT(system, targets[2], x; opt_method=Hopf_cd, opt_p=opt_p_cd, preH=preH_mrk18, intH=intH_mrk18, HJoc=HJoc_mrk18, time_p, printing=true, warm=true)
...
for (ti, th) in enumerate(0.:Δt:tf-Δt)
    ...
    # uˢ1, dˢ1, Tˢ1, ϕ1, dϕdz1 = Hopf_minT(system, targets[1], X[:, ti]; opt_method=Hopf_cd, opt_p=opt_p_cd_quick, preH=preH_mrk18, intH=intH_mrk18, HJoc=HJoc_mrk18, time_p, printing=false, warm, v_init_=v_init_1)
    # uˢ2, dˢ2, Tˢ2, ϕ2, dϕdz2 = Hopf_minT(system, targets[2], X[:, ti]; opt_method=Hopf_cd, opt_p=opt_p_cd_quick, preH=preH_mrk18, intH=intH_mrk18, HJoc=HJoc_mrk18, time_p, printing=false, warm, v_init_=v_init_2)

    uˢ1, dˢ1, Tˢ1, ϕ1, dϕdz1 = Hopf_minT(system, targets[1], X[:, ti]; opt_method=Hopf_cd, opt_p=opt_p_cd, preH=preH_mrk18, intH=intH_mrk18, HJoc=HJoc_mrk18, time_p, printing=false, warm, v_init_=v_init_1)
    uˢ2, dˢ2, Tˢ2, ϕ2, dϕdz2 = Hopf_minT(system, targets[2], X[:, ti]; opt_method=Hopf_cd, opt_p=opt_p_cd, preH=preH_mrk18, intH=intH_mrk18, HJoc=HJoc_mrk18, time_p, printing=false, warm, v_init_=v_init_2)
